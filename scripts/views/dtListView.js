define([ 
  ...
  'views/partSectionsView'
], function($, _, Backbone, dataTables, ListHeaderTemplate, ListItemTemplate, PartSectionsView) {
  ...
  var ListView = Backbone.View.extend({
    ...
    appendHeader : function() {
      return [
       { "sTitle": "Function group","sType": "numeric", "sWidth": "8em" }, 
  ...
  var ListItemView = Backbone.View.extend({
    ...
    clickRow : function (event) {
      ...
      var view = new PartSectionsView({
        model: this.model.attributes.sections
      });
